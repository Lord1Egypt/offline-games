class ExtraWordsButton extends Phaser.GameObjects.Container{
    ...
    constructor(scene){
        ...
        let perc = GameData.getExtraWordsCount() / wordPressParams.num_bonus_words_to_find_for_reward;
        
        this.circularProgress = scene.add.rexCircularProgress(0, -this.height * 0.013, this.width * 0.38, 0xF49431, perc, {
    ...
    coinAnim(){
        if(!this.rewardCoinsArr) {
            ...
            for(let i = 0; i < wordPressParams.num_coins_awarded_for_bonus_words; i++){
                ...
                coin.setDepth(this.scene.board.depth + 10);
        ...
        if(!this.smallParticles){
            ...
            this.smallParticles.setDepth(this.scene.board.depth + wordPressParams.num_coins_awarded_for_bonus_words + 10);
        }
            ...
            this.scene.tweens.add({
                ...
                onComplete      : function(){
                    ...
                    if(i == this.rewardCoinsArr.length - 1) {
                        ...
                        this.incrementCoinsWithAnimation();
                    }
                }
            });
        }
    ...
    incrementCoinsWithAnimation(){
        let targetValue = this.scene.hintController.getRemainingCoins() + wordPressParams.num_coins_awarded_for_bonus_words;
        ...
        this.scene.tweens.addCounter({
            ...
            onComplete      : function(){
                ...
                earnedBonusWordsReward(this.scene, wordPressParams.num_coins_awarded_for_bonus_words, this.scene.hintController.getRemainingCoins());
            }
        });
    }
